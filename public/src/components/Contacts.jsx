    ...
    <>
      {currentUserImage && currentUserImage && (
        <Container>
          <div className="brand">
          <h3>Toman</h3>
            <button onClick={toggleSearchBar}><img src={Logo} alt="logo" /></button>
            {searchBar && (
        <div className="modal">
          <div onClick={toggleSearchBar} className="overlay"></div>
          ...
          <div className="current-user" onClick={()=>navigate(`/profile/${currentUserName}`)}>
            <div className="avatar">
              <img
